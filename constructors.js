...
let car = new Car('Toyota','Camry',2021,'true');
console.log({car});
...
let question=new Question("Who is your best athlete",["KIpchoge","Kiprop","Kimutai"],"Kipchoge")
let userAnswer="HuseinBolt"
...
let quiz1=new Quiz()
let question1=new Question("Who are  your hobbies",["swiming","poetry","football"],"painting")
let question2=new Question("Who are your best football players",["Neymar","Christian","Modich"],"Messi")
quiz1.addQuestion(question1)
quiz1.addQuestion(question2)
quiz1.submitAnswer("poetry")
quiz1.nextQuestion()
quiz1.submitAnswer("Neymar")
